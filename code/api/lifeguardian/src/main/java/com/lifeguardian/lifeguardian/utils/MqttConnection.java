...
import com.lifeguardian.lifeguardian.boundaries.BrokerResources;
...
//    private final String password = config.getValue("mqtt.password", String.class);
    ...
    public MqttClient getClient() {
        return this.client; // Getter method to access the client
    }
    ...
    public void start() {
        try {
            ...
            mqttConnectOptions.setUserName("soulaimene");
            mqttConnectOptions.setPassword("soulaimeneforcotproject".toCharArray());
            ...
            client.setCallback(new MqttCallback() {
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    System.out.println("Message on " + topic + ": " + payload);
                    UserRepository userRepository = CDI.current().select(UserRepository.class).get();

                    // Call broadcast method when new sensor data arrives
                    if ("sensor/data".equals(topic)) {
                        BrokerResources.broadcast(payload);
...
//                }
            ...
            this.client.subscribe("sensor/data", 1);
