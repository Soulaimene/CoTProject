...
kmodes_model_female_path = CotProjectPath + r'\CoTProject\code\mlops\preprocess\kmodes_model_male.joblib'
kmodes_model_male_path =CotProjectPath+r'\CoTProject\code\mlops\preprocess\kmodes_model_female.joblib'
...
def apply_kmodes(user_cat):
    if user_cat.iloc[0]['gender'] == 0:  # Male
        kmodes_model_male = joblib.load(kmodes_model_male_path)
        ...
        kmodes_model_female = joblib.load(kmodes_model_female_path
        )
